...
let handler = async (m, { conn, args, text, usedPrefix: _p, command, isROwner }) => {
    ...
    //Manage panel
    const domain = "https://zrstore.panelrun.xyz" // Domain
const apikey = "ptla_HpvztajQnN7c0gcMQsoS4J6PPIWqEUlpktzi4eIpsuw" // Apikey
const c_apikey = "ptla_HpvztajQnN7c0gcMQsoS4J6PPIWqEUlpktzi4eIpsuw" // c Apikey

    const webPage = "https://zrstore.panelrun.xyz" // Web Page
...
> Perintah : ${_p + command} nomer/tag`);
            ...
            let f = await fetch(domain + "/api/application/users", {
                ...
                "body": JSON.stringify({
                    "email": "elistz21" + profil.toString() + "@gmail.com", // Email
                    "username": "xyroinee" + profil.toString(), // Username
                    "first_name": "Xyroinee" + profil.toString(), // Nama Depan
                    "last_name": "Xyroinee", // Nama Belakang
                    "language": "en", // Bahasa
                    "password": "badut" + password.toString() // Password
                })
            })
