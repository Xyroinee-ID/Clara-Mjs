...
export default {
  ...
  prems: JSON.parse(fs.readFileSync("./Setting/prems.json")) ?? ["6285760451683"], // cek di prems.json
  ...
  emailgh: "admin@xyroinee.xyz", // Setting to your email github
  usernamegh: "xyroinee", // setting to your username github
  ...
  home: "https://github.com/Xyroinee/Clara-MJS#readme",
  bug: "https://github.com/Xyroinee/Clara-MJS/issues",
